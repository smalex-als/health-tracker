...
public interface ContentRpcService {
  ...
  <T> void request(String method, String url, JavaScriptObject reqObject, AsyncCallback<T> asyncCallback);

  <T> void request(String url, JavaScriptObject reqObject, AsyncCallback<T> asyncCallback);
}
