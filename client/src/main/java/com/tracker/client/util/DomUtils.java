...
public class DomUtils {
  ...
  public static <T extends Element> T createDom(T el) {
    return createDom(el, null);
  }

  public static <T extends Element, K extends Node> T
      createDom(T el, String className, K ... children) {
